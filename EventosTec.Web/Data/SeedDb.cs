...
namespace EventosTec.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("Aldo", "Cuellar", "admin@adminmail.com", "664 123 45 67",
                 "Admin");
            var customer = await CheckUserAsync("Aldo", "Cuellar", "cliente@clientemail.com", "664 987 65 43",
                 "Client");
